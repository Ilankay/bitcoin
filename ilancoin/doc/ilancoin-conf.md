...
Changes to the configuration file while `ilancoind` or `ilancoin-qt` is running only take effect after restarting.
...
-- | -- | --
Windows | `%LOCALAPPDATA%\Ilancoin\` | `C:\Users\username\AppData\Local\Ilancoin\ilancoin.conf`
...
An example configuration file can be generated by [contrib/devtools/gen-ilancoin-conf.sh](../contrib/devtools/gen-ilancoin-conf.sh).
Run this script after compiling to generate an up-to-date configuration file.
The output is placed under `share/examples/ilancoin.conf`.
To use the generated configuration file, copy the example file into your data directory and edit it there, like so:

```
# example copy command for linux user
cp share/examples/ilancoin.conf ~/.ilancoin
```
