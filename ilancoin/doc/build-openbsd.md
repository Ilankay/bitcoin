...
This guide describes how to build ilancoind, command-line utilities, and GUI on OpenBSD.
...
Clone the Ilancoin Core repository to a directory. All build scripts and commands will run from this directory.
``` bash
...
...
to: /path/to/ilancoin/depends/*-unknown-openbsd*
```
