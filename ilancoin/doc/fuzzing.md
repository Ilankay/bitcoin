...
## Overview of Ilancoin Core fuzzing

[Google](https://github.com/google/fuzzing/) has a good overview of fuzzing in general, with contributions from key architects of some of the most-used fuzzers. [This paper](https://agroce.github.io/ilancoin_report.pdf) includes an external overview of the status of Ilancoin Core fuzzing, as of summer 2021.  [John Regehr](https://blog.regehr.org/archives/1687) provides good advice on writing code that assists fuzzers in finding bugs, which is useful for developers to keep in mind.
...
It is possible to specify `ilancoind` arguments to the `fuzz` executable.
...
the qa-assets repo
(https://github.com/ilancoin-core/qa-assets/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
# Fuzzing Ilancoin Core using afl++

## Quickstart guide

To quickly get started fuzzing Ilancoin Core using [afl++](https://github.com/AFLplusplus/AFLplusplus):
...
# Fuzzing Ilancoin Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Ilancoin Core using [Honggfuzz](https://github.com/google/honggfuzz):
...
Ilancoin Core participates in Google's [OSS-Fuzz](https://github.com/google/oss-fuzz/tree/master/projects/ilancoin-core)
program, which includes a dashboard of [publicly disclosed vulnerabilities](https://issues.oss-fuzz.com/issues?q=ilancoin-core%20status:open).

Ilancoin Core follows its [security disclosure policy](https://ilancoincore.org/en/security-advisories/),
...
OSS-Fuzz also produces [a fuzzing coverage report](https://oss-fuzz.com/coverage-report/job/libfuzzer_asan_ilancoin-core/latest).
