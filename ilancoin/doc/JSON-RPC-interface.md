...
This is the endpoint used by ilancoin-cli when a `-rpcwallet=` parameter is passed in.
...
ilancoin-cli createwallet mywallet false false "" false false true

# "params": {"wallet_name": "mywallet", "load_on_startup": true}
ilancoin-cli -named createwallet wallet_name=mywallet load_on_startup=true

# "params": {"args": ["mywallet"], "load_on_startup": true}
ilancoin-cli -named createwallet mywallet load_on_startup=true
```
...
- **Secure authentication:** By default, when no `rpcpassword` is specified, Ilancoin Core generates unique
