...
Assumeutxo is a feature that allows fast bootstrapping of a validating ilancoind
instance.
...
```
$ ilancoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ ilancoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
