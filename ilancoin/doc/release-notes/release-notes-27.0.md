Ilancoin Core version 27.0 is now available from:

  <https://ilancoincore.org/bin/ilancoin-core-27.0/>
...
libilancoinconsensus
-------------------

- libilancoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libilancoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Ilancoin Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Ilancoin Core would
