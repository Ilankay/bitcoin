...
Ilancoin Core version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Ilancoin Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Ilancoin Core version 0.18.0.
...
- Testing or debugging of implementations of the Ilancoin P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Ilancoin Core. Ilancoin Core logs debug messages
...
- OpenSSL is no longer used by Ilancoin Core.  (#17265)

- BIP70 support has been fully removed from Ilancoin Core. The
...
- All custom settings configured when Ilancoin Core starts are now
...
- The "Start Ilancoin Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://ilancoincore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Ilancoin Core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  automatically copy a Partially-Signed Ilancoin Transaction (PSBT) to
  the system clipboard.  This can then be pasted into an external
  program such as [HWI](https://github.com/ilancoin-core/HWI) for
  signing.  Future versions of Ilancoin Core should support a GUI option
...
- Ilancoin Core's automatically-generated source code documentation is
...
- #16983 Add detailed info about Ilancoin Core files (hebasto)
