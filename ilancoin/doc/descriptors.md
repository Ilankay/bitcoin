...
- Segwit addresses (bech32 and bech32m, of the form `bc1...` for mainnet or `tb1...` for testnet, defined in [BIP 173](https://github.com/ilancoin/bips/blob/master/bip-0173.mediawiki) and [BIP 350](https://github.com/ilancoin/bips/blob/master/bip-0350.mediawiki)).
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a Ilancoin Core descriptor wallet to serve as your
