...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./ilancoin-util":
        execprog = os.getenv("ILANCOINUTIL", default=execprog)
    elif testObj["exec"] == "./ilancoin-tx":
        execprog = os.getenv("ILANCOINTX", default=execprog)
