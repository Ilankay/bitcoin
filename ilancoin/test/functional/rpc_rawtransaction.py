...
class RawTransactionsTest(IlancoinTestFramework):
    ...
    def getrawtransaction_verbosity_tests(self):
        ...
        # Do this with a pruned chain, as a regression test for https://github.com/ilancoin/ilancoin/pull/29003
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 ITC/kvB
        ...
        # Fee rate is 0.20000000 ITC/kvB
