...
BASE_SCRIPTS = [
    ...
    'interface_ilancoin_cli.py --legacy-wallet',
    'interface_ilancoin_cli.py --descriptors',
...
def run_tests(*, test_list, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, combined_logs_len=0, failfast=False, use_term_control, results_filepath=None):
    ...
    if shutil.disk_usage(tmpdir).free < min_space:
        print(f"{BOLD[1]}WARNING!{BOLD[0]} There may be insufficient free space in {tmpdir} to run the Ilancoin functional test suite. "
    ...
    # a hard link or a copy on any platform. See https://github.com/ilancoin/ilancoin/pull/27561.
