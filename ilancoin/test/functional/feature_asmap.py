...
5. `ilancoind -asmap` restart with an addrman containing new and tried entries

6. `ilancoind -asmap` with no file specified and a missing default asmap file

7. `ilancoind -asmap` with an empty (unparsable) default asmap file
...
class AsmapTest(IlancoinTestFramework):
    ...
    def test_default_asmap(self):
        ...
        for arg in ['-asmap', '-asmap=']:
            self.log.info(f'Test ilancoind {arg} (using default map file)')
            self.stop_node(0)
    ...
    def test_asmap_interaction_with_addrman_containing_entries(self):
        self.log.info("Test ilancoind -asmap restart with addrman containing new and tried entries")
        self.stop_node(0)
        shutil.copyfile(self.asmap_raw, self.default_asmap)
    ...
    def test_asmap_health_check(self):
        self.log.info('Test ilancoind -asmap logs ASMap Health Check with basic stats')
        shutil.copyfile(self.asmap_raw, self.default_asmap)
