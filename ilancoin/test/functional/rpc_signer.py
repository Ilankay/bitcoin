...
Verify that a ilancoind node can use an external signer command.
...
class RPCSignerTest(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart ilancoind with -signer=<cmd>',
