#!/usr/bin/env python3
# Copyright (c) 2020-present The Ilancoin Core developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The ilancoind node closes feeler connections as soon as a version
...
class P2PAddConnections(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        # ilancoind behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that ilancoind sends its own version prior to processing
