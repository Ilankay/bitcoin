...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/ilancoin/ilancoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our ilancoind node")
