#!/usr/bin/env python3
# Copyright (c) 2018-2022 The Ilancoin Core developers
...
class ToolWalletTest(IlancoinTestFramework):
    ...
    def ilancoin_wallet_process(self, *args):
        ...
        return subprocess.Popen([self.options.ilancoinwallet] + default_args + list(args), stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
    ...
    def do_tool_createfromdump(self, wallet_name, dumpfile, file_format=None):
        ...
        self.assert_tool_output("The dumpfile may contain private keys. To ensure the safety of your Ilancoin, do not share the dumpfile.\n", '-wallet={}'.format(wallet_name), '-dumpfile={}'.format(rt_dumppath), 'dump')
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        self.assert_raises_tool_error('No method provided. Run `ilancoin-wallet -help` for valid methods.')
    ...
    def test_dump_unclean_lsns(self):
        ...
        # Lastly kill ilancoind so that the LSNs don't get reset
