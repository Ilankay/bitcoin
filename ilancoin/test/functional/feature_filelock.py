...
class FilelockTest(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that cookie and PID file are not deleted when attempting to start a second ilancoind using the same datadir")
        cookie_file = datadir / ".cookie"
        assert cookie_file.exists()  # should not be deleted during the second ilancoind instance shutdown
        pid_file = datadir / ILANCOIN_PID_FILENAME_DEFAULT
