...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"ilancoin-cli -h\" for help or \"ilancoin-cli listwallets\" to see "
...
class TestIlancoinCli(IlancoinTestFramework):
    ...
    def run_test(self):
        ...
        # Prevent ilancoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and ilancoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (ITC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (ITC/kvB)']), network_info['relayfee'])
