...
class AvoidReuseTest(IlancoinTestFramework):
    ...
    def test_full_destination_group_is_preferred(self):
        '''
        Test the case where [1] only has 101 outputs of 1 ITC in the same reused
        ...
        # Send 101 outputs of 1 ITC to the same, reused address in the wallet
        for _ in range(101):
            self.nodes[0].sendtoaddress(new_addr, 1)
    ...
    def test_all_destination_groups_are_used(self):
        '''
        Test the case where [1] only has 202 outputs of 1 ITC in the same reused
        address and tries to send a payment of 200.5 ITC. The wallet
        ...
        # Send 202 outputs of 1 ITC to the same, reused address in the wallet
        for _ in range(202):
            self.nodes[0].sendtoaddress(new_addr, 1)
