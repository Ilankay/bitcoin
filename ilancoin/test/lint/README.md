...
```sh
DOCKER_BUILDKIT=1 docker build -t ilancoin-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/ilancoin -it ilancoin-linter
```
...
* for `src/leveldb`: https://github.com/ilancoin-core/leveldb-subtree.git (branch ilancoin-fork)
* for `src/crypto/ctaes`: https://github.com/ilancoin-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/ilancoin-core/crc32c-subtree.git (branch ilancoin-fork)
