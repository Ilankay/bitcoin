...
**When configuring Ilancoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Ilancoin Core:
...
variables will be set when generating the Ilancoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
