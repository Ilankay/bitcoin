// Copyright (c) 2018-2021 The Ilancoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef ILANCOIN_EXTERNAL_SIGNER_H
#define ILANCOIN_EXTERNAL_SIGNER_H
...
#endif // ILANCOIN_EXTERNAL_SIGNER_H
