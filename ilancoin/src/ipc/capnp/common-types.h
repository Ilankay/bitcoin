...
#ifndef ILANCOIN_IPC_CAPNP_COMMON_TYPES_H
#define ILANCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between ilancoin processes.
...
//! Functions to serialize / deserialize common ilancoin types.
namespace mp {
...
#endif // ILANCOIN_IPC_CAPNP_COMMON_TYPES_H
