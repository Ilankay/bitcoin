...
#ifndef ILANCOIN_INTERFACES_INIT_H
#define ILANCOIN_INTERFACES_INIT_H
...
//! (ilancoin-gui, ilancoin-node, ilancoin-wallet, ilancoind, ilancoin-qt) and each
...
#endif // ILANCOIN_INTERFACES_INIT_H
