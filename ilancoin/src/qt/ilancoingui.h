...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, IlancoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Ilancoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(IlancoinUnit newUnits);
