...
{
    // Test regression https://github.com/ilancoin/ilancoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/ilancoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/ilancoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Ilancoin/Ilancoin-Qt.conf and all else left as default,
    // ilancoin-qt should set both -listen and -listenonion to false and start successfully.
