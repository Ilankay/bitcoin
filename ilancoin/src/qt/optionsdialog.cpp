      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->ilancoinAtStartup->setToolTip(ui->ilancoinAtStartup->toolTip().arg(CLIENT_NAME));
    ui->ilancoinAtStartup->setText(ui->ilancoinAtStartup->text().arg(CLIENT_NAME));

    ui->openIlancoinConfButton->setToolTip(ui->openIlancoinConfButton->toolTip().arg(CLIENT_NAME));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSITControls);
