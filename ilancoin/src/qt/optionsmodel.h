...
public:
    ...
    IlancoinUnit getDisplayUnit() const { return m_display_ilancoin_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSITControls() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    IlancoinUnit m_display_ilancoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(IlancoinUnit unit);
