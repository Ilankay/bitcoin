// Copyright (c) 2011-2022 The Ilancoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include <ilancoin-build-config.h> // IWYU pragma: keep
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &IlancoinGUI::createWallet);
...
void IlancoinGUI::createActions()
{
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Ilancoin Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Ilancoin Transaction from clipboard"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Ilancoin command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &IlancoinGUI::quitRequested);
    ...
    if(walletFrame)
    {
        ...
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &IlancoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &IlancoinGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &IlancoinGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &IlancoinGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &IlancoinGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &IlancoinGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET
...
void IlancoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &IlancoinGUI::setCurrentWalletBySelectorIndex);
...
void IlancoinGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
...
#ifdef ENABLE_WALLET
void IlancoinGUI::enableHistoryAction(bool privacy)
{
...
void IlancoinGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &IlancoinGUI::addWallet);
...
WalletController* IlancoinGUI::getWalletController()
{
...
void IlancoinGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &IlancoinGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &IlancoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &IlancoinGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &IlancoinGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &IlancoinGUI::incomingTransaction);
    connect(this, &IlancoinGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void IlancoinGUI::createTrayIconMenu()
{
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &IlancoinGUI::toggleHidden);
...
void IlancoinGUI::gotoLoadPSBT(bool from_clipboard)
{
...
void IlancoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Ilancoin network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void IlancoinGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void IlancoinGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void IlancoinGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    ...
    connect(dlg, &OptionsDialog::quitOnReset, this, &IlancoinGUI::quitRequested);
...
void IlancoinGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void IlancoinGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
#ifdef ENABLE_WALLET
void IlancoinGUI::incomingTransaction(const QString& date, IlancoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
static bool ThreadSafeMessageBox(IlancoinGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = IlancoinGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
bool IlancoinGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<IlancoinUnit> units = IlancoinUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const IlancoinUnit unit : units) {
...
{
    menu = new QMenu(this);
    for (const IlancoinUnit u : IlancoinUnits::availableUnits()) {
        menu->addAction(IlancoinUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(IlancoinUnit newUnits)
{
