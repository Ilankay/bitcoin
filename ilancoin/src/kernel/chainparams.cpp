...
buted under the MIT software license, see the accompanying
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWonk = uint256{"0x0000000000000000000000000000000000000000000000000000000100010001"};
...
public:
    CTestNet4Params() {
        ...
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("seed.testnet4.ilancoin.sprovoost.nl."); // Sjors Provoost
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.ilancoin.sprovoost.nl.");
