...
{
    BOOST_CHECK(TestSplitHost("www.ilancoincore.org", "www.ilancoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.ilancoincore.org]", "www.ilancoincore.org", 0));
    ...
    BOOST_CHECK(TestSplitHost("www.ilancoincore.org:65536", "www.ilancoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.ilancoincore.org:0", "www.ilancoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.ilancoincore.org:", "www.ilancoincore.org:", 0, false));
}
