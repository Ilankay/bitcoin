// Copyright (c) 2011-present The Ilancoin Core developers
...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common ilancoin"}; // Includes a space to catch possible path escape issues.
