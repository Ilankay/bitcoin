// Copyright (c) 2015-present The Ilancoin Core developers
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/ilancoin/ilancoin/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // ILANCOIN_TEST_UTIL_SETUP_COMMON_H
