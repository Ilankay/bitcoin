...
// Copyright (c) 2009-2021 The Ilancoin Core developers
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    switch (chain) {
    case ChainType::MAIN:
        return std::make_unique<CBaseChainParams>("", 2332, 2334);
    case ChainType::TESTNET:
        return std::make_unique<CBaseChainParams>("testnet3", 12332, 12334);
    case ChainType::TESTNET4:
        return std::make_unique<CBaseChainParams>("testnet4", 32332, 32334);
    case ChainType::SIGNET:
        return std::make_unique<CBaseChainParams>("signet", 32432, 32434);
    case ChainType::REGTEST:
        return std::make_unique<CBaseChainParams>("regtest", 12443, 12445);
    }
    assert(false);
}
