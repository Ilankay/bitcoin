...
#ifndef ILANCOIN_NODE_CONNECTION_TYPES_H
#define ILANCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/ilancoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Ilancoin’s Peer-to-Peer Network")
...
#endif // ILANCOIN_NODE_CONNECTION_TYPES_H
