...
First, in terms of structure, there is no particular concept of "Ilancoin Core
...
Before you start contributing, familiarize yourself with the Ilancoin Core build
system and tests. Refer to the documentation in the repository on how to build
Ilancoin Core and how to run the unit tests, functional tests, and fuzz tests.
...
You may also participate in the [Ilancoin Core PR Review Club](https://ilancoincore.reviews/).
...
`#ilancoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#ilancoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/ilancoin-core-dev/](https://www.erisian.com.au/ilancoin-core-dev/)
and [https://gnusha.org/ilancoin-core-dev/](https://gnusha.org/ilancoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/ilancoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/ilancoindev/](https://gnusha.org/pi/ilancoindev/).
...
fork of Ilancoin Core copies the merge. Instead, make any username mentions in a
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/ilancoin/ilancoin  # Fetch the latest upstream commit
