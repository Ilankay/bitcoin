#!/usr/bin/env python3
# Copyright (c) 2020-2022 The Ilancoin Core developers
...
parser.add_argument('-a', '--addr', dest='addr', default='', help='Ilancoin address to which the faucet should send')
...
def ilancoin_cli(rpc_command_and_params):
    argv = [args.cmd] + args.ilancoin_cli_args + rpc_command_and_params
    try:
...
if args.faucet.lower() == DEFAULT_GLOBAL_FAUCET:
    ...
    curr_signet_hash = ilancoin_cli(['getblockhash', '1'])
...
if args.addr == '':
    ...
    args.addr = ilancoin_cli(['getnewaddress', 'faucet', 'bech32'])
