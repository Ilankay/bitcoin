...
# Extract options
function __fish_ilancoin_tx_get_options
...
# Extract commands
function __fish_ilancoin_tx_get_commands
...
complete \
    --command ilancoin-tx \
    --condition "not __fish_ilancoin_seen_cmd (__fish_ilancoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_ilancoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command ilancoin-tx \
    --arguments "(__fish_ilancoin_tx_get_commands)" \
    --no-files
