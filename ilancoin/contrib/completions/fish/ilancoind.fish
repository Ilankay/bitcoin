...
complete --command ilancoind --no-files

# Extract options
function __fish_ilancoind_get_options
...
complete \
    --command ilancoind \
    --arguments "(__fish_ilancoind_get_options --nofiles)"
