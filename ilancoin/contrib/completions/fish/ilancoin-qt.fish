...
complete --command ilancoin-qt --no-files

# Extract options
function __fish_ilancoinqt_get_options
...
complete \
    --command ilancoin-qt \
    --arguments "(__fish_ilancoinqt_get_options --nofiles)"
