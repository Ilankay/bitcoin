#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Ilancoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of ilancoin node seed ip addresses.')
...
def main():
    ...
    print(f'{ip_stats(ips):s} Filter out hosts with multiple ilancoin ports', file=sys.stderr)
