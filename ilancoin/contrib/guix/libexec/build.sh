#!/usr/bin/env bash
# Copyright (c) 2019-2022 The Ilancoin Core developers
...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/ilancoin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    case "$HOST" in
        *darwin*)
            ...
            mv build/dist/Ilancoin-Core.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
    ...
    (
        ...
        # copy over the example ilancoin.conf file. if contrib/devtools/gen-ilancoin-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/share/examples/ilancoin.conf" "${DISTNAME}/"
